        ...
        <ResponsiveContainer width="100%" height="100%">
          {isOscillation && typeof data[0][metrics[0]] === 'string' ? (
            ...
            <LineChart data={data}>
              ...
              <Legend />
              <Line type="step" dataKey={metrics[0]} stroke="#a78bfa" strokeWidth={2} dot={false} animationDuration={500}/>
              {metrics[1] && <Line type="step" yAxisId="right" dataKey={metrics[1]} stroke="#38bdf8" strokeDasharray="3 3" />}
            </LineChart>
          ) : (
